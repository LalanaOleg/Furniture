(() => {
    ...
    function formRating() {
        ...
        function initRatings() {
            ...
            function setRatingActiveWidth(rating, index = ratingValue.innerHTML) {
                let letterSpacing = parseFloat(getComputedStyle(rating).letterSpacing);
                letterSpacing = Number.isNaN(letterSpacing) ? 0 : letterSpacing;
                const ratingActiveWidth = index / .05 - letterSpacing / 5;
